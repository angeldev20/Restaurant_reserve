            ...
            if(typeof window.google.maps !== "undefined"){
                ...
                jQuery('.gmaps-active').each(function(){
                    var mapElement      = this,
                        ...
                        markerImage     = typeof mapInstance.attr('data-marker-image') !== typeof undefined ? mapInstance.attr('data-marker-image'): '/assets/mapmarker.png',
                        markerTitle     = "Dinelyy",
                    ...
                    if(address !== undefined && address[0] !== ""){
                            geocoder.geocode( { 'address': address[0].replace('[nomarker]','')}, function(results, status) {
                                ...
                                address.forEach(function(address){
                                    ...
                                    markerImage = {url: typeof window.mr_variant === typeof undefined ? typeof markerImage !== "object" ? markerImage: markerImage.url : '/assets/mapmarker.png', scaledSize: new google.maps.Size(50,50)};
